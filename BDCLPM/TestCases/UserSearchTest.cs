...
public class UserSearchTest
{
    ...
    public static void RunAllTests(IWebDriver driver)
    {
        ...
        // Chạy các test case
        Test_TK_INT_01_SearchValidKeyword(driver);
        Test_TK_INT_02_SearchNoResults(driver);
        Test_TK_INT_03_SearchPagination(driver);
        Test_TK_INT_04_BrowseByCategory(driver);
        Test_TK_INT_06_BrowseByCountryYear(driver);
    ...
    /// </summary>
    public static void Test_TK_INT_01_SearchValidKeyword(IWebDriver driver)
    {
        ...
        try
        {
            ...
            bool hasResults = searchResults.Count > 0 || driver.PageSource.Contains("Lật Mặt");

            Console.WriteLine($"  ✅ Step 1 PASS: Tìm kiếm 'Lật Mặt'");
            Console.WriteLine($"     📊 Số kết quả: {searchResults.Count}");
            Console.WriteLine($"     📊 Có chứa từ khóa: {hasResults}");
            test?.Pass($"Step 1: Search 'Lật Mặt' - Results: {searchResults.Count}");
    ...
    /// </summary>
    public static void Test_TK_INT_02_SearchNoResults(IWebDriver driver)
    {
    ...
    /// </summary>
    public static void Test_TK_INT_03_SearchPagination(IWebDriver driver)
    {
    ...
    /// </summary>
    public static void Test_TK_INT_04_BrowseByCategory(IWebDriver driver)
    {
    ...
    /// </summary>
    public static void Test_TK_INT_06_BrowseByCountryYear(IWebDriver driver)
    {

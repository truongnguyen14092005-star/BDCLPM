...
public class UserWatchMovieTest
{
    ...
    public static void RunAllTests(IWebDriver driver)
    {
        ...
        // Chạy các test case
        Test_XP_INT_01_SearchWatchResume(driver);
        Test_XP_INT_02_WatchSeriesEpisodes(driver);
        Test_XP_INT_03_WatchHistoryAutoSave(driver);
        Test_XP_INT_04_TopMoviesHomePage(driver);
        Test_XP_INT_05_WatchWithoutLogin(driver);
    ...
    /// </summary>
    public static void Test_XP_INT_01_SearchWatchResume(IWebDriver driver)
    {
    ...
    /// </summary>
    public static void Test_XP_INT_02_WatchSeriesEpisodes(IWebDriver driver)
    {
    ...
    /// </summary>
    public static void Test_XP_INT_03_WatchHistoryAutoSave(IWebDriver driver)
    {
    ...
    /// </summary>
    public static void Test_XP_INT_04_TopMoviesHomePage(IWebDriver driver)
    {
    ...
    /// </summary>
    public static void Test_XP_INT_05_WatchWithoutLogin(IWebDriver driver)
    {
